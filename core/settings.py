...
SECRET_KEY = "django-insecure-*w7wej*(c@lneignsb4wz)&*bt=o3fsqewy+(4#^1vigm#-z9*"
...
# URL a usar cuando se refieren a archivos estáticos con la etiqueta {% static %}
STATIC_URL = '/static/'
