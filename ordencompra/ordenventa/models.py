...
class OrdenDeCompra(models.Model):
    ...
    # Aqui sera la orden de pago perdonemem por no hacerlo separado T_T 
    ...
    numero_movimiento_bancario = models.CharField(max_length=255, null=True, blank=True, verbose_name="Número de Movimiento Bancario")
    banco_relacionado = models.CharField(max_length=255, null=True, blank=True, verbose_name="Banco Relacionado")
    ...
    def save(self, *args, **kwargs):
        ...
        self.restante_rendir = Decimal(self.precio_total) - Decimal(self.monto_pagado)
...
def create_or_update_orden_de_compra(sender, instance, created, **kwargs):
    OrdenDeCompra.objects.update_or_create(
        ...
        defaults={
            ...
            "precio_actual": instance.total_bruto,  # Asumiendo un valor por defecto
