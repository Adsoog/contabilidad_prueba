...
def actualizar_pago(request, pk):
    if request.method == 'POST':
        ...
        # Actualizar numero_movimiento_bancario
        numero_movimiento_bancario = request.POST.get('numero_movimiento_bancario')
        if numero_movimiento_bancario:
            orden.numero_movimiento_bancario = numero_movimiento_bancario
        
        # Actualizar banco_relacionado
        banco_relacionado = request.POST.get('banco_relacionado')
        if banco_relacionado:
            orden.banco_relacionado = banco_relacionado
